...
<Accordion title="Version 3.4 - Released on 2025-04-10">
  ...
  | **Feature**                              | **Description**                                                                                               |
  | :--------------------------------------- | :------------------------------------------------------------------------------------------------------------ |
  | **Introduction to Payments**             | Added a new section under `Documentation → Payments` covering:<br>- Key Participants in the Card Payments Ecosystem<br>- How Card Payments Work – From Initiation to Authorization<br>- Settlement – How Merchants Receive Their Funds<br>- Our Role – What We Offer and How We Simplify Payments.<br>[View Section](/documentation/payments/introduction-to-payments) |
  | **API Navigation Update**                | Added **Purchase API (V2)** and **Authorisation API (V2)** under the **Server To Server** menu in the API Reference. |
