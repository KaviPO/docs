...
<Accordion title="Version 3.6.3 - Patch Released on 2026-01-19">

  #### Updates & Changes

  | **Change**                          | **Description**                                                                 |
  | :---------------------------------- | :------------------------------------------------------------------------------ |
  | **Refund API – E-Wallet Limitation** | Refunds are **not supported** for transactions made using **PayPay, Pay-Easy, and Konbini** payment methods. |

  **Note:** This update is a **documentation clarification** and does not introduce any functional API changes.
