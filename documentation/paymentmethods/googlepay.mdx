---
title: Google Pay
description: Learn how to accept Google Pay using the Hosted Payment Page (HPP).
---

# Google Pay

Google Pay allows customers to complete transactions quickly using payment methods saved to their Google Account. When enabled, our Hosted Payment Page (HPP) dynamically displays the **Google Pay** button, providing a smooth, one-click checkout experience.
...
Make sure you use `"paymentMethod": "gpay"` in your test request.
