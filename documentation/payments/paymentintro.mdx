...
- Technology That Support the Payment Flow  
...
Our system supports both **automatic capture (Purchase)** and **manual capture (Authorisation)** flows, depending on how you configure your transactions. Captured payments are sent in batches to the acquirer, processed by the card schemes, and the final settled amount is deposited into your account, minus applicable fees.
