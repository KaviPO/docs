---
title: 'Authorization API (v1 - Legacy)'
...
<Wanrning>Notice: Authorization API (v1) is scheduled for deprecation. [Use v2 (/api-reference/authorizationv2) for future integrations.</Warning>
