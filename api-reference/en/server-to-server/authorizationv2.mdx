---
title: 'Authorization API (v2)'
openapi: '/api-reference/en/open-api-config/server-to-server/authorizationv2.json POST /api/v1/server-to-server-interface/authorizationv2'
